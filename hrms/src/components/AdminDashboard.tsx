...
export default function AdminDashboard() {
    ...
    const fetchSchedule = async (employeeId: string) => {
        ...
        // Map fetched schedules or create defaults
        const mapped = days.map(day => {
            const existing = data.schedules?.find((s: any) => s[1] === day);
            return {
                day,
                s1Start: existing ? existing[2] : '',
                s1End: existing ? existing[3] : '',
                s2Start: existing ? existing[4] : '',
                s2End: existing ? existing[5] : ''
            };
        });
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded shadow">
                    <h3 className="text-gray-500 text-sm font-medium">Asistencia de Hoy</h3>
            ...
            {/* Attendance Table */}
            <div className="bg-white p-6 rounded shadow">
                <h2 className="text-xl font-semibold mb-4">Asistencia de Empleados</h2>
                            ...
                            {attendance.map((record, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-medium">
                                        {record.observation && (
                                            <span className={
                                                record.observation.includes('Atraso') || record.observation.includes('Falta') ? 'text-red-600' :
                                                    record.observation.includes('Extra') || record.observation.includes('favor') ? 'text-green-600' :
                                                        'text-gray-600'
                                            }>
                                                {record.observation}
                                            </span>
            ...
            <div className="bg-white p-6 rounded shadow">
                <h2 className="text-xl font-semibold mb-4">Gestión Avanzada de Horarios</h2>
                <div className="mb-4">
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                ...
                                <tr className="bg-gray-50">
                                    <td colSpan={5} className="px-4 py-2 text-right font-bold">Total Semanal:</td>
            ...
            {/* Leave Requests */}
            <div className="bg-white p-6 rounded shadow">
                <h2 className="text-xl font-semibold mb-4">Gestión de Solicitudes de Permiso</h2>
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {requests.map((req) => {
                                ...
                                return (
                                    <tr key={req.id}>
                                        <td className="px-6 py-4 whitespace-nowrap">{req.employeeId}</td>
                ...
                {isDocumentsOpen && (
                    <div className="p-6 pt-0 border-t">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <h3 className="text-lg font-medium mb-2">Subir Nuevo Documento</h3>
                            ...
                            <div>
                                <h3 className="text-lg font-medium mb-2">Documentos Existentes</h3>
                                                ...
                                                return (
                                                    <tr key={doc.id}>
                                                        ...
                                                        <td className="px-4 py-2 text-sm text-gray-500">
                                                            <a href={doc.fileLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                                                {doc.fileName}
                                                            </a>
